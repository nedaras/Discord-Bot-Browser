...
const isResponseAnError = (response: JsonObject | ResponseError): response is ResponseError => (response as ResponseError).error !== undefined || (response as ResponseError).message !== undefined